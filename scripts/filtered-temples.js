...
const temples = [
    ...
    {
        templeName: "Palmyyra New York",
        location: "Palmyra, New York, United States",
        dedicated: "2000, April, 6",
        area: 10700,
        imageUrl:
            "images/Pal_temple.jpeg"
    },
    {
        templeName: "Mesa Arizona",
        location: "Mesa, Arizona, United States",
        dedicated: "1927, September, 23",
        area: 113916,
        imageUrl:
            "images/mesa_az.jpeg"
    },
...
oldTemplesLink.addEventListener("click", () => {
    let oldTemples = temples.filter(temple => new Date(temple.dedicated) <= new Date("1900, January, 1"));

    createTempleCard(oldTemples);
});

newTemplesLink.addEventListener("click", () => {
    let newTemples = temples.filter(temple => new Date(temple.dedicated) >= new Date("2000, January, 1"));
